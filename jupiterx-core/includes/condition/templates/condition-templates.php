...
<script type="text/html" id="jupiterx-conditions-modal-header">
	<div class="dialog-header dialog-lightbox-header">
		<div class="elementor-templates-modal__header jx-conditions-trigger-popup-dialog-header">
			<div class="elementor-templates-modal__header__logo-area">
				<div class="jx-popup-dialog-header-content">
					<span class="header-logo">
						<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
							<path fill-rule="evenodd" clip-rule="evenodd" d="M8.00578 5.19137L11.6662 0H15.6374L9.98564 8L9.98563 8L8.00577 10.8086L8.00578 10.8086L4.34535 16H0.36261L6.01441 8L6.0144 8L0.36261 0H4.34535L8.00577 5.19136L8.00578 5.19137ZM9.98564 8L15.6374 16H11.6662L8.00578 10.8086L9.98564 8Z" fill="white"></path>
						</svg>
					</span>
					<h4 class="jx-conditions-modal-title"><?php echo esc_html__('Publish Settings', 'jupiterx-core'); ?></h4>
				</div>
			</div>
