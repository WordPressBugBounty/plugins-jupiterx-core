	...
	private function style_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .raven-content-toggle-switcher' => '--raven-content-switch-knob-translate: calc(-{{SIZE}}{{UNIT}}/2);',
					'body.rtl {{WRAPPER}} .raven-content-toggle-switcher' => '--raven-content-switch-knob-translate: calc({{SIZE}}{{UNIT}}/2);',
					'{{WRAPPER}} .raven-content-switch-label' => 'width: {{SIZE}}{{UNIT}} !important;height: calc({{SIZE}}{{UNIT}}/2) !important;',
					'{{WRAPPER}} .raven-content-switch-input:checked + .raven-content-switch-input-control:before' => 'transform: translateX(var(--raven-content-switch-knob-translate)) !important;width: calc({{SIZE}}{{UNIT}}/2 - 8px) !important;height: calc({{SIZE}}{{UNIT}}/2 - 8px) !important;',
					'{{WRAPPER}} .raven-content-switch-input-control:before' => 'width: calc({{SIZE}}{{UNIT}}/2 - 8px) !important;height: calc({{SIZE}}{{UNIT}}/2 - 8px) !important;',
				],
			]
		);
	...
	?>
		<div class="raven-content-toggle-switcher">
			<div class="raven-content-switch-primary-label <?php echo esc_attr($primary_is_default); ?>">
				<h4>
					<?php echo esc_html( __( $settings['primary_section_label'], 'jupiterx-core' ) ); // phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralText -- String from widget setting. ?>
				</h4>
			</div>
			<div <?php
			...
			<div class="raven-content-switch-secondary-label <?php echo esc_attr($secondary_is_default); ?>">
				<h4>
					<?php echo esc_html( __( $settings['secondary_section_label'], 'jupiterx-core' ) ); // phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralText -- String from widget setting. ?>
				</h4>
			</div>
		</div>
<?php
